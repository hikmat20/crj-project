...
<div class="box box-primary">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="id_customer" value='<?php echo $cus->id_customer; ?>' required name="id_customer" readonly placeholder="Id Suplier">
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <select id="id_category_customer" name="id_category_customer" class="form-control select" required>
                                        ...
                                        <?php foreach ($results['category'] as $category) {
                                            ...
                                            ?>
                                        <option value="<?php echo $category->id_category_customer; ?>" <?php echo $select; ?>><?php echo $category->name_category_customer; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="name_customer" value='<?php echo $cus->name_customer; ?>' required name="name_customer" placeholder="Nama Customer">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="telephone" value='<?php echo $cus->telephone; ?>' required name="telephone" placeholder="Nomor Telephone">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="telephone_2" value='<?php echo $cus->telephone_2; ?>' name="telephone_2" placeholder="Nomor Telephone">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="fax" required name="fax" value='<?php echo $cus->fax; ?>' placeholder="Nomor Fax">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="email" required name="email" value='<?php echo $cus->email; ?>' placeholder="email@domain.adress">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="date" class="form-control" id="start_date" required name="start_date" value='<?php echo $cus->start_date; ?>' placeholder="Tanggal Mulai">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <select id="id_karyawan" name="id_karyawan" class="form-control select" required>
                                        ...
                                        <?php foreach ($results['karyawan'] as $karyawan) {
                                            ...
                                            ?>
                                        <option value="<?php echo $karyawan->id_karyawan; ?>" <?php echo $select; ?>><?php echo $karyawan->nama_karyawan; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                                ...
                                <div class="col-md-6">
                                    <select id="id_prov" name="id_prov" class="form-control select" onchange="get_kota()" required>
                                        ...
                                        <?php foreach ($results['prof'] as $prof) {
                                            ...
                                            ?>
                                        <option value="<?php echo $prof->id_prov; ?>" <?php echo $select; ?>><?php echo ucfirst(strtolower($prof->nama)); ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <select id="id_kota" name="id_kota" class="form-control select" required>
                                        ...
                                        <?php foreach ($results['kota'] as $kota) {
                                            ...
                                            ?>
                                        <option value="<?php echo $kota->id_kota; ?>" <?php echo $select; ?>><?php echo ucfirst(strtolower($kota->nama_kota)); ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea type="text" name="address_office" id="address_office" class="form-control input-sm required w70" placeholder="Alamat"><?php echo $cus->address_office; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="zip_code" value='<?php echo $cus->zip_code; ?>' required name="zip_code" placeholder="Kode Pos">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="longitude" value='<?php echo $cus->longitude; ?>' required name="longitude" placeholder="Longtitude">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="latitude" value='<?php echo $cus->latitude; ?>' required name="latitude" placeholder="Latitude">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                        ...
                        <div class="col-sm-12">
                            <?php
                                echo form_button(['type' => 'button', 'class' => 'btn btn-md btn-success', 'value' => 'back', 'content' => 'Add', 'id' => 'add-category']);
    ?>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-12">
    ...
    foreach ($results['cate'] as $cate) {
        ...
        echo '</tr>';
                        ...
                        <div class="col-sm-12">
                            <?php
                                echo form_button(['type' => 'button', 'class' => 'btn btn-md btn-success', 'value' => 'back', 'content' => 'Add', 'id' => 'add-payment']);
    ?>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-12">
        ...
        echo '</tr>';
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="name_bank" value='<?php echo $cus->name_bank; ?>' required name="name_bank" placeholder="Nama Bank">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="no_rekening" value='<?php echo $cus->no_rekening; ?>' required name="no_rekening" placeholder="No Rekening">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="nama_rekening" value='<?php echo $cus->nama_rekening; ?>' required name="nama_rekening" placeholder="Nama Rekening">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea type="text" name="alamat_bank" id="alamat_bank" class="form-control input-sm required w70" placeholder="Alamat_Bank"><?php echo $cus->alamat_bank; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="swift_code" value='<?php echo $cus->swift_code; ?>' required name="swift_code" placeholder="Swift Code">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="npwp" value='<?php echo $cus->npwp; ?>' required name="npwp" placeholder="Nomor NPWP">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="npwp_name" value='<?php echo $cus->npwp_name; ?>' required name="npwp_name" placeholder="Nama NPWP">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="npwp_address" value='<?php echo $cus->npwp_address; ?>' required name="npwp_address" placeholder="Alamat NPWP">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <select id="payment_term" name="payment_term" class="form-control select" required>
                                        <option value="<?php echo $cus->payment_term; ?>"><?php echo $cus->payment_term; ?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="nominal_dp" value='<?php echo $cus->nominal_dp; ?>' required name="nominal_dp" placeholder="Alamat NPWP">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <select id="sisa_pembayaran" name="sisa_pembayaran" class="form-control select" required>
                                        <option value="<?php echo $cus->sisa_pembayaran; ?>"><?php echo $cus->sisa_pembayaran; ?></option>
                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="time" class="form-control" id="start_recive" value='<?php echo $cus->start_recive; ?>' required name="start_recive" placeholder="Latitude">
                                </div>
                                <div class="col-md-2">
                                    <label for="customer">END</label>
                                </div>
                                <div class="col-md-4">
                                    <input type="time" class="form-control" id="end_recive" value='<?php echo $cus->end_recive; ?>' required name="end_recive" placeholder="Latitude">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <textarea type="text" name="address_invoice" id="address_invoice" class="form-control input-sm required w70" placeholder="Alamat"><?php echo $cus->adress_invoice; ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $('#add-category').click(function() {
        ...
        Template += '<option value="<?php echo $category->name_category_customer; ?>"><?php echo ucfirst(strtolower($category->name_category_customer)); ?></option>';
        Template += '<?php } ?>';
        Template += '</select>';
        Template += '</td>';
        Template += '</td>';
