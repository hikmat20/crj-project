...
{
	//Permission
	protected $viewPermission 	= 'Configs.View';
	protected $addPermission  	= 'Configs.Add';
	protected $managePermission = 'Configs.Manage';
	protected $deletePermission = 'Configs.Delete';
	...
	public function __construct()
	{
		...
		$this->load->model(array(
			'Configs/Configs_model',
			'Aktifitas/aktifitas_model',
		));
		$this->template->title('Basic Configurations');
		$this->template->page_icon('fas fa-cogs');
	...
	public function save()
	{
		...
		$data = $post;
		$data['id'] = isset($post['id']) && $post['id'] ? $post['id'] : $this->Configs_model->generate_id();
