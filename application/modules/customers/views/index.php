            ...
            <table id="dataTable" class="table table-bordered display table-striped border-right-0 border-left-0" width="100%">
                <thead>
                    <tr>
                        ...
                        <th class="desktop tablet mobile tx-bold tx-dark" width="25%">Customer Name</th>
                        <th class="desktop tablet mobile">Telephone</th>
                        <!-- <th class="desktop tablet">Email</th> -->
                        <th class="desktop tablet">Address</th>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.edit', function() {
        ...
        if (id) {
            ...
            $("#dialog-popup .modal-title").html('<i class="<?= $template['page_icon']; ?>" aria-hidden="true"></i> Edit Customer');
        } else {
    ...
    $(document).on('click', '.view', function() {
        ...
        if (id) {
            ...
            $("#dialog-popup .modal-title").html('<i class="<?= $template['page_icon']; ?>" aria-hidden="true"></i> View Customer');
        } else {
            $("#dialog-popup .modal-body").html("<h5 class='text-center'>Data tidak valid</h5>");
        }
        $("#dialog-popup").modal();
