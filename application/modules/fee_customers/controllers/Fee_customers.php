	...
	public function getData()
	{
		...
		foreach ($query->result_array() as $row) {
			...
			if (isset($ArrDtlUND[$row['id']])) foreach ($ArrDtlUND[$row['id']] as $rowUND) {
				$listUND .= "<li>" . $ArrCNT[$rowUND->container_id] . " - Rp. " . number_format($rowUND->cost_value) . "</li>";
			}

			if (isset($ArrDtlDDU[$row['id']])) foreach ($ArrDtlDDU[$row['id']] as $rowDDU) {
				$listDDU .= "<li>" . $ArrCNT[$rowDDU->container_id] . " - Rp. " . number_format($rowDDU->cost_value) . "</li>";
			}
