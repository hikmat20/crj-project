...
<div class="br-pagebody pd-x-20 pd-sm-x-30 mg-y-3">
    <div class="card bd-gray-400">
        <div class="card-header pd-5 bg-white">
            <ul class="nav nav-pills nav-fill flex-column flex-md-row  justify-content-center tx-bold tx-dark wd-50p"
                role="tablist">
                <li class="nav-item"><a class="nav-link tx-center active" data-toggle="tab" href="#std"
                        role="tab">STANDARD</a></li>
                <li class="nav-item"><a class="nav-link tx-center" data-toggle="tab" href="#cust"
        ...
        <div class="tab-content br-profile-body">
            <div class="tab-pane fade active show" id="std">
                <div class="pd-10">
                    <?php if ($ENABLE_ADD) : ?>
                    <button class="btn btn-primary btn-oblong add" href="javascript:void(0)" title="Add"><i
                            class="fa fa-plus">&nbsp;</i>Add New Fee</button>
                    <?php endif; ?>
                </div>
                <!-- <hr class="mg-0"> -->
            ...
            <div class="tab-pane fade" id="cust">
                <div class="pd-10">
                    <?php if ($ENABLE_ADD) : ?>
                    <button class="btn btn-primary btn-oblong add2" href="javascript:void(0)" title="Add"><i
                            class="fa fa-plus">&nbsp;</i>Add New Fee</button>
                    <?php endif; ?>
                </div>
...
$(document).on('click', '.add', function() {
    $('#dialog-popup .modal-title').html(
        "<i class='<?= $template['page_icon']; ?>'></i> Add Fee Lartas Standard")
    $("#dialog-popup").modal();
...
$(document).on('click', '.add2', function() {
    $('#dialog-popup .modal-title').html(
        "<i class='<?= $template['page_icon']; ?>'></i> Add Fee Lartas Customer")
    $("#dialog-popup").modal();
