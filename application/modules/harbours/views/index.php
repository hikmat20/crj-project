...
<script type="text/javascript">
    ...
    $(document).on('click', '.add', function() {
        $('#dialog-popup .modal-title').html("<i class='<?= $template['page_icon']; ?>'></i> Add New Shipment Port")
        $("#dialog-popup").modal();
    ...
    $(document).on('click', '.edit', function(e) {
        var id = $(this).data('id');
        $('#dialog-popup .modal-title').html("<i class='<?= $template['page_icon']; ?>'></i> Edit Shipment Port")
        $("#dialog-popup").modal();
    ...
    $(document).on('click', '.view', function(e) {
        var id = $(this).data('id');
        $('#dialog-popup .modal-title').html("<i class='<?= $template['page_icon']; ?>'></i> View Shipment Port")
        $("#dialog-popup").modal();
