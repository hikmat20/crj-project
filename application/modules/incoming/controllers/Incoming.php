...
class Incoming extends Admin_Controller
{
	...
	public function TambahData(){
		...
		<td				hidden		><input  type='text' 		value='".number_format($material->totalwidth,2)."'	class='form-control input-sm text-right' id='dt_qtyorder_".$id."_".$no."' 		required name='dt[".$id."][detail][".$no."][qtyorder]'     readonly></td>
		<td				hidden		><input  type='text' 		value='1'									class='form-control input-sm text-right autoNumeric' id='dt_qtyrecive_".$id."_".$no."' 		required name='dt[".$id."][detail][".$no."][qtyrecive]' 	></td>
...
function FormPo()
	...
	<div id='po_".$id."'>
		...
		<div class='form-group row' >
			...
			<th hidden width='7%'>Qty Order (Kg)</th>
			<th hidden width='7%'>Coil</th>
			<th width='12%'>Id Coil</th>
			<th width='7%'>Berat/Coil </th>
