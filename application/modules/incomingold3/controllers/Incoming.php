...
class Incoming extends Admin_Controller
{
	...
	public function TambahData(){
		...
		<td						><input  type='text' 		value='".number_format($material->width,2)."'		class='form-control input-sm text-right' id='dt_weight_".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][weight]' 		readonly></td>
		<td						><input  type='text' 		value='".number_format($material->totalwidth,2)."'	class='form-control input-sm text-right' id='dt_qtyorder_".$id."_".$no."' 		required name='dt[".$id."][detail][".$no."][qtyorder]'     readonly></td>
		<td						><input  type='text' 		value='1'									class='form-control input-sm text-right autoNumeric' id='dt_qtyrecive_".$id."_".$no."' 		required name='dt[".$id."][detail][".$no."][qtyrecive]' 	></td>
		<td						><input  type='text' 											class='form-control input-sm text-right autoNumeric' id='dt_widthrecive".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][widthrecive]' 		></td>
	...
	public function TambahDataRepeat(){
		...
		<td				hidden	><input  type='number' 		value='".$material->width."'		class='form-control' id='dt_weight_".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][weight]' 		readonly></td>
		<td						><input  type='hidden' 		value='".$material->totalwidth."'class='form-control' id='dt_qtyorder_".$id."_".$no."' 		required name='dt[".$id."][detail][".$no."][qtyorder]'     readonly></td>
		<td						><input  type='text' 		value='1'									class='form-control text-right input-sm autoNumeric' id='dt_qtyrecive_".$id."_".$no."' 		required name='dt[".$id."][detail][".$no."][qtyrecive]' 	></td>
		<td						><input  type='text' 											class='form-control text-right input-sm autoNumeric' id='dt_widthrecive".$id."_".$no."' 			required name='dt[".$id."][detail][".$no."][widthrecive]' 		></td>
    ...
    foreach($Detail AS $val => $valx){
      ...
      foreach($valx['detail'] AS $val2 => $valx2){
	       ...
	       foreach($valx['detail'] AS $val2 => $valx2){
			...
			$ArrStok[$val2.$val]['thickness'] 			= $thickness;
