<?php
$ENABLE_ADD     = has_permission('Lartas.Add');
$ENABLE_MANAGE  = has_permission('Lartas.Manage');
$ENABLE_VIEW    = has_permission('Lartas.View');
$ENABLE_DELETE  = has_permission('Lartas.Delete');
?>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.view', function(e) {
        var id = $(this).data('id');
        $('#dialog-popup .modal-title').html("<span class='<?= $template['page_icon']; ?>'></span> View Container")
        $("#dialog-popup").modal();
