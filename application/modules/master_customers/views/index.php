...
<div class="nav-tabs-supplier">
  <ul class="nav nav-tabs">
    <li class="active"><a href="#customer" data-toggle="tab" aria-expanded="true">Master Customer</a></li>
...
<script type="text/javascript">
	...
	$(document).on('click', '.view_category', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'master_customers/EditInternasional/'+id,
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
	...
	$(document).on('click', '.view_international', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'master_customers/viewInternasional/'+id,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
