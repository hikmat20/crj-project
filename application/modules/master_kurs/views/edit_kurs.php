		...
		<form id="data-form" method="post">
					  <div class="col-sm-12">
						   <div class="input_fields_wrap2">
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="" value="<?= $category->kode ?>" readonly required name="kode" placeholder="Id Category Suplier">
									    </div>
										</div>
										<div class="form-group row">
										<div class="col-md-4">
									    ...
									    <div class="col-md-6">
											<input type="date" class="form-control" id="" value="<?= $tanggal ?>" required name="tgl_ubah" placeholder="Category Supliery">
									    </div>
										</div>
										<div class="form-group row">
										<div class="col-md-4">
									    <label for="customer">Nilai Tukar</label>
									    </div>
									    <div class="col-md-6">
											<input type="number" class="form-control" id="" value="<?= $category->kurs ?>" required name="kurs" placeholder="Category Supliery">
									    </div>
										</div>
										</div>
						  </div>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'master_kurs/saveEditKurs';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
