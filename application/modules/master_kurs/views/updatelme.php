 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		<div class="form-group row">
			...
			echo"<td align='left'><input type='text' class='form-control input-sm' name='data1[".$loop."][nilai_compotition]'  value='$komposisi->nominal_harga' id='data1_".$loop."_nilai_compotition' label='FALSE' div='FALSE'></td>";								
											}?>	
										</tbody>
								</table>
							</div>
