...
?>
 <div class="box box-primary">
    <div class="box-body">
		...
		<div class="form-group row">
			<div class="col-md-4">
				<label for="customer">Update By</label>
			</div>
			<div class="col-md-8">
				<input type="text" class="form-control" id="user"  value="<?= $users->nm_lengkap ?>" onkeyup required name="user" readonly >
			</div>
		</div>
		</div>
							</div>
							...
							<div class="col-md-12">
								...
								<table class='table table-bordered table-striped'>
										<thead>
											<tr class='bg-blue'>
												<td align='center'><b>Nama Komposisi</b></td>	
												<td align='center'><b>Harga Komposisi</b></td>
											</tr>
										...
										<?php
											...
											$loop++;
												echo"<tr id='tr_".$loop."'>";
			echo"<td align='left' hidden><input type='text' class='form-control input-sm'  name='data1[".$loop."][id_compotition]' value='$komposisi->id_compotition' id='data1_".$loop."_id_compotition' label=/FALSE' div='FALSE'></td>";
			echo"<td align='left'><input type='text' class='form-control input-sm' name='data1[".$loop."][nama_compotition]' readonly value='$komposisi->name_compotition' id='data1_".$loop."_nama_compotition' label=/FALSE' div='FALSE'></td>";
			echo"<td align='left'><input type='text' class='form-control input-sm autoNumeric' name='data1[".$loop."][nilai_compotition]'  value='$komposisi->nominal_harga' id='data1_".$loop."_nilai_compotition' label='FALSE' div='FALSE'></td>";								
											}?>	
										</tbody>
								</table>
							</div>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'master_lme/saveUpdate';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
