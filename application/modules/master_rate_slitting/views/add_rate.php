									...
									<table class='table table-bordered table-striped'>
										<thead>
											<tr class='bg-blue'>
												...
												<td align='center'><b>Rate / Menit</b></td>
...
$('#add-payment').click(function(){
			...
			Template	+='<input type="text" class="form-control input-sm" name="data1['+loop+'][keterangan]" id="data1_'+loop+'_keterangan" label="FALSE" div="FALSE">';
			Template	+='</td>';
			Template	+='<td align="left">';
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'master_rate_slitting/saveNewRate';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
