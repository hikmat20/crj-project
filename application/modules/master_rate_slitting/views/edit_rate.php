		...
		<form id="data-form" method="post">
					  <div class="col-sm-12">
						   <div class="input_fields_wrap2">
									    ...
									    <div class="col-md-6">
									<input type="text" class="form-control" id="" required name="keterangan" value="<?= $rate->keterangan ?>" placeholder="Nama Inventory">
									    </div>
										</div>
										<div class="form-group row">
										<div class="col-md-4">
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'master_rate_slitting/SaveEditRate';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
