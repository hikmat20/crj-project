...
<div class="modal modal-default fade" id="dialog-popup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title" id="myModalLabel"><span class="fa fa-users"></span>&nbsp;Master Rate Slitting</h4>
      </div>
...
<script type="text/javascript">
	...
	$(document).on('click', '.edit_rate', function(e){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'master_rate_slitting/EditRate/'+id,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
	...
	$(document).on('click', '.view_rate', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'master_rate_slitting/viewRate/'+id,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
	...
	$(document).on('click', '.add_rate', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'master_rate_slitting/addRate',
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
