		...
		<form id="data-form" method="post">
					  <div class="col-sm-12">
						   <div class="input_fields_wrap2">
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="" readonly required name="id_categorry_supplier" placeholder="Id Category Suplier">
									    </div>
										</div>
										<div class="form-group row">
										<div class="col-md-4">
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="" required name="name_category_supplier" placeholder="Category Supliery">
									    </div>
										</div>
										<div class="form-group row" hidden>
										<div class="col-md-4">
									    <label for="customer">Kode Kategori Suplier</label>
									    </div>
									    <div class="col-md-6">
											<input type="text" class="form-control" id="" required name="supplier_code" placeholder="Category Suplier Code">
									    </div>
										</div>
										</div>
						  </div>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'master_suplier/saveNewCategory';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
