					...
					<div class="row">
							...
							<div class="col-sm-6">
								<div class="form-group row">
									...
									<div class="col-md-6">
											<input type="text" class="form-control" id="id_supplier" required name="id_supplier" readonly placeholder="Id Suplier">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-6">
						...
						<div class="col-sm-6">
							...
							<div class="form-group row">
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="moq" required name="moq" placeholder="MOQ Suplier ">
									    </div>
										</div> 
						</div>
						<br>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'master_suplier/saveNewLocal';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
