...
<div class="box box-primary">
	...
	<div class="box-body">
		<form id="data_form">
		<input type="hidden" name="id_inventory" id="id_inventory" value='<?= $inven->id_surface ?>'>
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group row">
					<div class="col-md-3">
					 ...
					 <div class="col-md-9">
					  <input type="text" class="form-control" id="nm_inventory" required name="nm_inventory" placeholder="Nama Type" value="<?= $inven->nm_surface ?>">
					</div>
				</div>
				<div class="form-group row">
					<div class="col-md-3">
...
<script type="text/javascript">
	...
	$(document).on('submit', '#data_form', function(e){
		...
		function(){
		  $.ajax({
			  type:'POST',
			  url:siteurl+'master_surface/saveEditsurface',
			  dataType : "json",
			  data:data,
