					  ...
					  <div class="col-sm-8">
						   <div class="input_fields_wrap2">
									...
									<table class='table table-bordered table-striped'>
										<thead>
											<tr class='bg-blue'>
												<td align='center'><b>Cost Element</b></td>	 
												<td align='center'><b>Type Rate</b></td>							
												<td align='center'><b>Nominal Rate</b></td>
...
$('#add-payment').click(function(){
			...
			Template	='<tr id="tr_'+loop+'">';
				Template	+='<td align="left">';
					Template	+='<input type="text" class="form-control input-sm" name="data1['+loop+'][cost_element]" id="data1_'+loop+'_cost_element" label="FALSE" div="FALSE">';
				Template	+='</td>';	
			Template	+='<td align="center">';
				Template	+='<select name="data1['+loop+'][id_type_rate]" id="data1_'+loop+'_id_type_rate" class="form-control input-sm chosen-select">';
				Template	+='<option value="">-- Type Rate --</option>';
							Template	+='<?php foreach ($results['type'] as $type){?>';
							Template	+='<option value="<?= $type->id_type_rate?>"><?= ucfirst(strtolower($type->type_rate))?></option>';
							Template	+='<?php } ?>';			
				Template	+='</select>';
			Template	+='</td>';
			Template	+='<td align="left">';
					Template	+='<input type="text" class="form-control input-sm" name="data1['+loop+'][presentase_rate]" id="data1_'+loop+'_presentase_rate" label="FALSE" div="FALSE">';
			Template	+='</td>';
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'masterrate_ferrous/saveNewRate';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
