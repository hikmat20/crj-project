		...
		<form id="data-form" method="post">
					  <div class="col-sm-12">
						   <div class="input_fields_wrap2">
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="" readonly required name="id_type_rate" placeholder="Id Category Suplier">
									    </div>
										</div>
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="" required name="type_rate" placeholder="Type Rate">
									    </div>
										</div>
										</div>
						  </div>
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'masterrate_ferrous/saveNewType';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
