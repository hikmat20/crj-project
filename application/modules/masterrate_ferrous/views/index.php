...
<script type="text/javascript">
	...
	$(document).on('click', '.edit_type', function(e){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'masterrate_ferrous/EditTypeRate/'+id,
			data:{'id':id},
	...
	$(document).on('click', '.edit_rate', function(e){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'masterrate_ferrous/EditRate/'+id,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
	...
	$(document).on('click', '.view_type', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'masterrate_ferrous/viewType/'+id,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
	...
	$(document).on('click', '.view_rate', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'masterrate_ferrous/viewRate/'+id,
			data:{'id':id},
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
	...
	$(document).on('click', '.add_rate', function(){
		...
		$.ajax({
			type:'POST',
			url:siteurl+'masterrate_ferrous/addRate',
			success:function(data){
				$("#dialog-popup").modal();
				$("#ModalView").html(data);
	...
	$(document).on('click', '.delete_rate', function(e){
		...
		function(){
		  $.ajax({
			  type:'POST',
			  url:siteurl+'masterrate_ferrous/deleteRate',
			  dataType : "json",
			  data:{'id':id},
	...
	$(document).on('click', '.delete_type', function(e){
		...
		function(){
		  $.ajax({
			  type:'POST',
			  url:siteurl+'masterrate_ferrous/deleteType',
			  dataType : "json",
			  data:{'id':id},
			  success:function(result){
				  if(result.status == '1'){
