		...
		<form id="data-form" method="post">
					  <div class="col-sm-12">
						   <div class="input_fields_wrap2">
										...
										<div class="col-md-4">
									    <label for="customer">ost Element</label>
									    </div>
										 <div class="col-md-6" hidden>
											<input type="text" class="form-control" id="" required name="id_rate" value="<?= $rate->id_rate ?>" placeholder="Nama Inventory">
									    </div>
									    <div class="col-md-6">
											<input type="text" class="form-control" readonly id="" required name="cost_element" value="<?= $rate->cost_element ?>" placeholder="Nama Inventory">
									    </div>
										</div>
										<div class="form-group row">
										<div class="col-md-4">
									    ...
									    <div class="col-md-6">
											  <select id="id_type_rate"  name="id_type_rate" readonly  class="form-control select" required>
						...
						<?php } ?>
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" readonly id="" required name="presentase_rate" value="<?= $rate->presentase_rate ?>" placeholder="Nama Inventory">%
									    </div>
										</div>
