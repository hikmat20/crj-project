...
<div class="box box-primary">
    ...
    <div class="box-header">
        <div class="form-group">
            ...
            <a href="<?= site_url('supplier/create') ?>" class="btn btn-success"
                title="<?= lang('supplier_btn_new') ?>"><?= lang('supplier_btn_new') ?></a>
            <?php endif; ?>
            <div class="pull-right">
                <div class="input-group">
                    <input type="text" name="table_search" value="<?php echo isset($search) ? $search : ''; ?>"
                        class="form-control pull-right" placeholder="Search" autofocus />
        ...
        <table class="table table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php if($ENABLE_MANAGE) : ?>
                    <td style="padding-right:20px"><a class="text-black"
                            href="<?= site_url('supplier/edit/' . $record->id_supplier); ?>" data-toggle="tooltip"
                            data-placement="left" title="Edit Data"><i class="fa fa-pencil"></i></a></td>
                    <?php endif; ?>
                </tr>
                <?php $numb++; endforeach; ?>
            </tbody>
    ...
    <div class="box-footer clearfix">
        ...
        <input type="submit" name="delete" class="btn btn-danger" id="delete-me"
            value="<?php echo lang('supplier_btn_delete') ?>"
            onclick="return confirm('<?= (lang('supplier_delete_confirm')); ?>')">
        <?php endif;
