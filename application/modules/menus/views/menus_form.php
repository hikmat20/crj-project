                ...
                <div class="box-body">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="hidden" id="id" name="id"
                            value="<?php echo set_value('id', isset($data->id) ? $data->id : ''); ?>">

                        <label for="id" class="col-sm-2 control-label">ID Menu<font size="4" color="red"><B>*</B></font>
                            </label>
                        <div class="col-sm-3">
                        ...
                        <label for="title" class="col-sm-2 control-label">Menu's Name <font size="4" color="red">
                                <B>*</B></font></label>
                        <div class="col-sm-3">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                <input type="text" class="form-control" id="title" name="title" maxlength="45"
                                    value="<?php echo set_value('title', isset($data->title) ? $data->title : ''); ?>"
                                    placeholder="Menu's Name" required>
                            </div>
                        </div>
                    </div>

                    <div class="form-group ">
                        <label for="link" class="col-sm-2 control-label">Path Menu<font size="4" color="red"><B>*</B>
                            </font></label>
                        <div class="col-sm-3">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                <input type="text" class="form-control" id="link" name="link"
                                    value="<?php echo set_value('link', isset($data->link) ? $data->link : ''); ?>"
                                    placeholder="Link" required>
                            </div>
                        </div>

                        <label for="link" class="col-sm-2 control-label">Parent Menu<font size="4" color="red"><B>*</B>
                            </font></label>
                        <div class="col-sm-3">
                            <div class="input-group">
                    ...
                    <div class="form-group ">
                        <label for="link" class="col-sm-2 control-label">Show Status<font size="4" color="red"><B>*</B>
                            </font></label>
                        <div class="col-sm-3">
                            <div class="input-group">
                                <div class="input-group-btn">
                                ...
                                <select class="form-control input select2 group_menu" name="group_menu" id="group_menu">
                                    ...
                                    <option value="<?=$i?>"
                                        <?=(isset($data->group_menu)&&$i==$data->group_menu)?"selected":""?>>
                                        <?=($datgroupmenu[$i]=="Back End")?"Show":"Hidden"?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        <label for="parent_id" class="col-sm-2 control-label">Icon<font size="4" color="red"><B>*</B>
                            </font></label>
                        <div class="col-sm-3">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-image"></i></span>
                                <input type="text" class="form-control" id="icon" name="icon"
                                    value="<?php echo set_value('icon', isset($data->icon) ? $data->icon : ''); ?>"
                        ...
                        <div class="col-sm-2">
                            <div class="input-group">
                                ...
                                <select id="status" name="status" class="form-control">
                                    <option value="1"
                                        <?= set_select('status', '1', isset($data->status) && $data->status == '1'); ?>>
                                        Active
                                    </option>
                                    <option value="0"
                                        <?= set_select('status', '0', isset($data->status) && $data->status == '0'); ?>>
                                        Inactive
                                    </option>
                                </select>
                            </div>
                    ...
                    <div class="form-group ">
                        <label for="parent_id" class="col-sm-2 control-label">Order<font size="4" color="red"><B>*</B>
                            </font></label>
                        <div class="col-sm-3">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-image"></i></span>
                                <input type="text" class="form-control" id="order" name="order"
                                    value="<?php echo set_value('order', isset($data->order) ? $data->order : ''); ?>"
                                    placeholder="order menu" required>
                            </div>
                        </div>
                        <?php if (isset($data->id)): ?>
                        <label for="link" class="col-sm-2 control-label">Permission ID<font size="4" color="red">
                                <B>*</B></font></label>
                        <div class="col-sm-3">
                            <div class="input-group">
                                <div class="input-group-btn">
                    ...
                    <div class="box-footer">
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                <button type="submit" name="save" class="btn btn-success" id="submit"><i
                                        class="fa fa-save">&nbsp;</i>Save</button>
                                <a class="btn btn-danger" data-toggle="modal" onclick="cancel()"><i
