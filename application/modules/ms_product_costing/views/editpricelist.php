                    ...
                    <div class="col-sm-12">
                        <div class="col-sm-6">  		
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control" id="id_product_pricelist" value="<?= $hd->id_product_pricelist?>" required name="id_product_pricelist" readonly placeholder="No.CRCL">
                                </div>
								<div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <option value="">-- Pilih Purpose Product (Lv 1) --</option>
                                        <?php foreach ($results['inventory_1'] as $inventory_1){
                                         $select1 = $hd->id_type == $inventory_1->id_type ? 'selected' : '';	?>
                                        ?>
                                        <option value="<?= $inventory_1->id_type?>"<?=$select1?>><?= $inventory_1->nama?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php foreach ($results['inventory_2'] as $inventory_2){
                                         $select2 = $hd->id_category1 == $inventory_2->id_category1 ? 'selected' : '';	?>
                                    ?>
                                    <option value="<?= $inventory_2->id_category1?>"<?=$select2?>><?= $inventory_2->nama?></option>
                                    <?php } ?>
                                    </select>
                                </div>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php foreach ($results['inventory_4'] as $inventory_4){
                                         $select4 = $hd->id_category3 == $inventory_4->id_category3 ? 'selected' : '';	?>
                                    ?>
                                    <option value="<?= $inventory_4->id_category3?>"<?=$select4?>><?= $inventory_4->nama?></option>
                                    <?php } ?>
                                    </select>
                                </div>
                            </div>
								...
								<select id="id_material" name="id_material" class="form-control select" onChange='GetProduk()' required>
											<option value="">--Pilih--</option>
												<?php foreach ($results['material'] as $material){
                                                    $select5 = $hd->id_formula == $material->id_category2 ? 'selected' : '';	?>
												?>
											<option value="<?= $material->id_category2?>"<?=$select5?>><?= ucfirst(strtolower($material->nama_category2))?></option>
												<?php } ?>
										</select>
								</div>
							</div>
                    ...
                    <div class="col-sm-12">
						<div class="col-sm-6">
							<div class="form-group row">
								...
								<div class="col-md-6">
									<input type="text" class="form-control autoNumeric" id="harga_beli"  value="<?=$hd->harga_beli?>" required name="harga_beli" placeholder="Purchase Price">
								</div>
							</div>
						</div>
							...
							<div class="form-group row" >
								<table class='table table-bordered table-striped'>
                                    ...
                                    <?php $loop=1;
                                        ...
                                        $idpricelist = $hd->id_product_pricelist;
                                        $bm		  = $this->db->query("SELECT a.* FROM ms_product_pricelist_detail as a WHERE a.id_product_pricelist='$idpricelist' AND nama_komponen=1 ")->row();
                                        $lc		  = $this->db->query("SELECT a.* FROM ms_product_pricelist_detail as a WHERE a.id_product_pricelist='$idpricelist' AND nama_komponen=2 ")->row();
                                        $oc		  = $this->db->query("SELECT a.* FROM ms_product_pricelist_detail as a WHERE a.id_product_pricelist='$idpricelist' AND nama_komponen=3 ")->row();
                                        $margin	  = $this->db->query("SELECT a.* FROM ms_product_pricelist_detail as a WHERE a.id_product_pricelist='$idpricelist' AND nama_komponen=4 ")->row();
                                        $dd		  = $this->db->query("SELECT a.* FROM ms_product_pricelist_detail as a WHERE a.id_product_pricelist='$idpricelist' AND nama_komponen=5 ")->row();
                                        $da		  = $this->db->query("SELECT a.* FROM ms_product_pricelist_detail as a WHERE a.id_product_pricelist='$idpricelist' AND nama_komponen=6 ")->row();
                                        $de		  = $this->db->query("SELECT a.* FROM ms_product_pricelist_detail as a WHERE a.id_product_pricelist='$idpricelist' AND nama_komponen=7 ")->row();
                                        $aj		  = $this->db->query("SELECT a.* FROM ms_product_pricelist_detail as a WHERE a.id_product_pricelist='$idpricelist' AND nama_komponen=8 ")->row();
                                        ...
                                        echo	"<td id='persentase_bm_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_persentase_bm_$loop' required name='dt[$loop][persentase_bm]' value='$bm->persentase' readonly></td>
                                                 <td id='nilai_bm_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_bm_$loop' required name='dt[$loop][nilai_bm]'  value='$bm->nilai_costing' readonly></td>
                                                 <td id='nilai_bm_rp_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_bm_rp_$loop' required name='dt[$loop][nilai_bm_rp]'  value='$bm->nilai_rupiah' readonly></td>
                                        ...
                                        echo	"<td id='persentase_lc_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_persentase_lc_$loop' required name='dt[$loop][persentase_lc]' value='$lc->persentase' readonly></td>
                                                 <td id='nilai_lc_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_lc_$loop' required name='dt[$loop][nilai_lc]' readonly value='$lc->nilai_costing'></td>
                                                 <td id='nilai_lc_rp_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_lc_rp_$loop' required name='dt[$loop][nilai_lc_rp]' readonly value='$lc->nilai_rupiah'></td>
                                        ...
                                        echo	"<td id='persentase_oc_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_persentase_oc_$loop' required name='dt[$loop][persentase_oc]' value='$oc->persentase' readonly></td>
                                                 <td id='nilai_oc_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_oc_$loop' required name='dt[$loop][nilai_oc]' readonly value='$oc->nilai_costing'></td>
                                                 <td id='nilai_oc_rp_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_oc_rp_$loop' required name='dt[$loop][nilai_oc_rp]' readonly value='$oc->nilai_rupiah'></td>
                                        ...
                                        echo	"<td id='persentase_margin_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_persentase_margin_$loop' required name='dt[$loop][persentase_margin]' value='$margin->persentase' readonly></td>
                                                 <td id='nilai_margin_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_margin_$loop' required name='dt[$loop][nilai_margin]' readonly value='$margin->nilai_costing'></td>
                                                 <td id='nilai_margin_rp_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_margin_rp_$loop' required name='dt[$loop][nilai_margin_rp]' readonly value='$margin->nilai_rupiah'></td>
                                        ...
                                        echo	"<td id='persentase_dd_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_persentase_dd_$loop' required name='dt[$loop][persentase_dd]' value='$dd->persentase' readonly></td>
                                                 <td id='nilai_dd_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_dd_$loop' required name='dt[$loop][nilai_dd]' readonly value='$dd->nilai_costing'></td>
                                                 <td id='nilai_dd_rp_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_dd_rp_$loop' required name='dt[$loop][nilai_dd_rp]' readonly value='$dd->nilai_rupiah'></td>
                                        ...
                                        echo	"<td id='persentase_da_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_persentase_da_$loop' required name='dt[$loop][persentase_da]' value='$da->persentase' readonly></td>
                                                 <td id='nilai_da_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_da_$loop' required name='dt[$loop][nilai_da]' readonly value='$da->nilai_costing'></td>
                                                 <td id='nilai_da_rp_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_da_rp_$loop' required name='dt[$loop][nilai_da_rp]' readonly value='$da->nilai_rupiah'></td>
                                        ...
                                        echo	"<td id='persentase_de_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_persentase_de_$loop' required name='dt[$loop][persentase_de]' value='$de->persentase' readonly></td>
                                                 <td id='nilai_de_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_de_$loop' required name='dt[$loop][nilai_de]' readonly value='$de->nilai_costing'></td>
                                                 <td id='nilai_de_rp_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_de_rp_$loop' required name='dt[$loop][nilai_de_rp]' readonly value='$de->nilai_rupiah'></td>
                                    ...
                                    echo	"<td id='persentase_aj_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_persentase_aj_$loop' required name='dt[$loop][persentase_aj]' value='$aj->persentase' readonly></td>
                                             <td id='nilai_aj_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_aj_$loop' required name='dt[$loop][nilai_aj]' readonly value='$aj->nilai_costing'></td>
                                             <td id='nilai_aj_rp_$loop'><input type='text' align='right' class='form-control input-sm autoNumeric' id='used_nilai_aj_rp_$loop' required name='dt[$loop][nilai_aj_rp]' readonly value='$aj->nilai_rupiah'></td>
				...
				return false;
					...
					swal({
						...
						if (isConfirm) {
								...
								var baseurl=siteurl+'ms_product_costing/SaveEditPricelist';
								$.ajax({
									url			: baseurl,
									type		: "POST",
									data		: formData,
