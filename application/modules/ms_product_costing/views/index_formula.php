...
<div class="box">
	<div class="box-header">
            <?php if($ENABLE_ADD) : ?>
				<a class="btn btn-success btn-sm" href="<?= base_url('/ms_product_costing/AddFormula/') ?>"  title="Add New"><i class="fa fa-plus">&nbsp;</i>Add</i></a>
			<?php endif; ?>
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_MANAGE) : ?>
				<a class="btn btn-primary btn-sm" href="<?= base_url('/ms_product_costing/revisiFormula/'.$record->id_product_costing) ?>" title="Edit" data-no_inquiry="<?=$record->no_inquiry?>"><i class="fa fa-edit"></i>
				</a>
			<?php endif; ?>
