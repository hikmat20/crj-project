<?php
$ENABLE_ADD     = has_permission('Ocean_freights.Add');
$ENABLE_MANAGE  = has_permission('Ocean_freights.Manage');
$ENABLE_VIEW    = has_permission('Ocean_freights.View');
$ENABLE_DELETE  = has_permission('Ocean_freights.Delete');
?>
...
<div class="d-flex align-items-center justify-content-between pd-x-20 pd-sm-x-30 pd-t-25 mg-b-20 mg-sm-b-30">
    ...
    <?php if ($ENABLE_ADD) : ?>
        <button class="btn btn-primary btn-oblong add" data-toggle="tooltip" title="Add"><i class="fa fa-plus">&nbsp;</i>Add New Freight</button>
    <?php endif; ?>
</div>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.add', function() {
        $('#dialog-popup .modal-title').html("<i class='<?= $template['page_icon']; ?>' ></i> Add New Ocean Freight")
        $("#dialog-popup").modal();
    ...
    $(document).on('click', '.edit', function(e) {
        var id = $(this).data('id');
        $('#dialog-popup .modal-title').html("<i class='<?= $template['page_icon']; ?>' ></i> Edit Ocean Freight")
        $("#dialog-popup").modal();
    ...
    $(document).on('click', '.view', function(e) {
        var id = $(this).data('id');
        $('#dialog-popup .modal-title').html("<i class='<?= $template['page_icon']; ?>' ></i> View Ocean Freight")
        $("#dialog-popup").modal();
