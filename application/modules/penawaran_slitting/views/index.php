...
<div class="box">
	<div class="box-header">
			<?php if($ENABLE_VIEW) : ?>
			<a class="btn btn-success btn-sm" href="<?= base_url('/penawaran_slitting/add/') ?>"  title="Tambah"><i class="fa fa-plus">&nbsp;</i>Add</i></a>
			<?php endif; ?>
	...
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_VIEW) : ?>
			<a class="btn btn-primary btn-sm" href="<?= base_url('/penawaran_slitting/PrintHeader/'.$record->id_slitting) ?>"  title="Print" target='_blank'><i class="fa fa-print">&nbsp;</i></i></a>
				</a>
			<?php endif; ?>

			<?php if($ENABLE_MANAGE) : ?>
			<a class="btn btn-primary btn-sm" href="<?= base_url('/penawaran_slitting/edit/'.$record->id_slitting) ?>"  title="Edit"><i class="fa fa-edit">&nbsp;</i></i></a>
				</a>
			<?php endif; ?>
<!--
			<?php if($ENABLE_VIEW) : ?>
