...
<div class="modal fade effect-scale" id="dialog-deal" data-backdrop="static" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel" aria-hidden="true">
...
$(document).ready(function() {
    ...
    $(document).on('click', '.view', function(e) {
        ...
        $('#dialog-popup .modal-title').html(
            "<i class='<?= $template['page_icon']; ?>'></i> View Quotation [" + number + "]")
        $("#dialog-popup").modal();
    ...
    $(document).on('click', '.deal', function(e) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (val.isConfirmed) {
                ...
                $('#dialog-deal .modal-body').load(siteurl + thisController +
                    'reviewQuotation/' + id)
            }
        })
    })
