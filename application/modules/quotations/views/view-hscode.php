    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-md-7">:
                    <?= (isset($hs) && $hs->cukai ? $hs->cukai : '0') . ((isset($hs->unit_cukai) && $hs->unit_cukai) ? $unit[$hs->unit_cukai] : ''); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-7">:
                    <?= (isset($hs) && $hs->bmad ? $hs->bmad : '0') . " " . ((isset($hs->unit_bmad) && $hs->unit_bmad) ? $unit[$hs->unit_bmad] : '-'); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-md-5 tx-dark tx-bold">
                ...
                <div class="col-md-7">:
                    <?= (isset($hs) && $hs->bmtp ? $hs->bmtp : '0') .  ((isset($hs->unit_bmtp) && $hs->unit_bmtp) ? $unit[$hs->unit_bmtp] : ''); ?>
                </div>
            </div>
            <div class="row">
                <div class="col-md-5 tx-dark tx-bold">
