<?php if ($header->status == 'CNL') : ?>
    <div class="alert alert-danger" role="alert">
        <h5 class="alert-heading">Cancel Reason : </h5>
        <p><?= $header->cancel_reason; ?></p>
        <!-- <p class="mb-0"><?= $header->cancel_reason; ?></p> -->
    </div>
<?php endif; ?>
                                ...
                                <tr>
                                    ...
                                    <th class="align-middle">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" name="discount_value" id="discount_value" readonly value="<?= number_format($header->discount_value); ?>" class="number-format form-control bg-transparent border-0 text-right tx-16-force tx-dark tx-bold" placeholder="0" autocomplete="off">
                                        </div>
                                    </th>
                                </tr>
                                <tr class="table-secondary">
                    ...
                    <tbody class="tx-dark">
                        <tr>
                            ...
                            <td class="text-right" width="100">
                                <div class="input-group input-group-sm">
                                    <input type="number" readonly name="payment_term[DP1][percentage]" id="percentage_dp1" data-id="dp1" class="percentage form-control bg-transparent form-control-sm text-right" placeholder="0" value="<?= (isset($ArrPayTerm['DP1']->percentage) && $ArrPayTerm['DP1']->percentage) ? $ArrPayTerm['DP1']->percentage : '30'; ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group input-group-sm">
                                    <input type="number" readonly name="payment_term[DP3][percentage]" id="percentage_dp3" data-id="dp3" class="percentage bg-transparent form-control form-control-sm text-right" placeholder="0" value="<?= (isset($ArrPayTerm['DP3']->percentage) && $ArrPayTerm['DP3']->percentage) ? $ArrPayTerm['DP3']->percentage : '17'; ?>">
                                    <div class="input-group-append">
                                        <span class="input-group-text">%</span>
                                    </div>
                                </div>
