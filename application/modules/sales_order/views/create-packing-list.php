                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="supplier_name" class="form-control form-control-sm"
                            value="<?= $dataSO->supplier_name; ?>" required data-parsley-inputs
                            placeholder="Supplier Name" aria-describedby="helpId">
                    </div>
                    <div class="form-group mb-4">
                        <textarea type="text" name="supplier_address" class="form-control form-control-sm"
                            placeholder="Address" aria-describedby="helpId"><?= $dataSO->supplier_address; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">Consignee :</label>
                        <input type="text" name="company_name" class="form-control form-control-sm"
                            value="<?= $dataSO->company_name; ?>" placeholder="Company Name" aria-describedby="helpId">
                    </div>
                    <div class="form-group">
                        <textarea type="text" name="company_address" class="form-control form-control-sm"
                            placeholder="Company Address"
                            aria-describedby="helpId"><?= $dataSO->company_address; ?></textarea>
                    </div>
                    ...
                    <div class="input-third-party">
                        ...
                        <div class="form-group">
                            <input type="text" name="trd_company_name" required
                                value="<?= $dataSO->trd_company_name; ?>" class="form-control form-control-sm"
                                placeholder="Company Name">
                        </div>
                        <div class="form-group">
                            <textarea type="text" name="trd_company_address" required
                                class="form-control form-control-sm"
                                placeholder="Company Address"><?= $dataSO->trd_company_address; ?></textarea>
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="input-qq">
                        <?php if ($dataSO->qq == 'Y') : ?>
                        <div class="form-group">
                            <input type="text" name="qq_company_name" require value="<?= $dataSO->qq_company_name; ?>"
                        ...
                        <div class="form-group">
                            <textarea type="text" name="qq_company_address" require class="form-control form-control-sm"
                                placeholder="Company Address"><?= $dataSO->qq_company_address; ?></textarea>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="from" class="form-control form-control-sm"
                            value="<?= $dataSO->from; ?>" placeholder="From" aria-describedby="helpId">
                    </div>

                    <div class="form-group">
                        <label for="" class="tx-dark tx-bold">TO :</label>
                        <input type="text" name="to" class="form-control form-control-sm" value="<?= $dataSO->to; ?>"
                            placeholder="To.." aria-describedby="helpId">
                    </div>

                    <div class="form-group">
                        <label for="" class="tx-dark tx-bold">Incoterm : </label>
                        <input type="text" name="incoterm" class="form-control form-control-sm"
                            value="<?= $dataSO->incoterm; ?>" placeholder="Incoterm" aria-describedby="helpId">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <div class="btn-group float-right" role="group" aria-label="Basic example">
                <a href="<?= base_url($this->uri->segment(1) . "/export/" . $dataSO->id); ?>" target="_blank"
            ...
            <table id="detailItem" class="table table-bordered table-sm border">
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <input type="text" name="detail[<?= $n; ?>][unit_package]"
                                id="unit_package_<?= $dtl->id; ?>" class="form-control form-control-sm text-center"
                        ...
                        <td class="text-right">
                            <input type="text" name="detail[<?= $n; ?>][cbm]" id="cbm_<?= $dtl->id; ?>"
                                class="form-control form-control-sm text-center cbm int" placeholder="0">
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
                <tfoot class="">
                    <tr class="bg-light">
                        ...
                        <th class="align-middle text-center tx-bold border">
                            <input type="text" name="total_nett_weight" id="total_nett_weight" readonly
                                class="form-control tx-bold tx-dark form-control-sm border-0 text-right readonly tx-14 bg-transparent"
                                placeholder="0">
                        </th>
                        <th class="align-middle text-center tx-bold border">
                            <input type="text" name="total_gross_weight" id="total_gross_weight" readonly
                                class="form-control tx-bold tx-dark form-control-sm border-0 text-right readonly tx-14 bg-transparent"
                                placeholder="0">
                        </th>
                        <th class="text-right tx-bold border-right-0 border">
                            <input type="text" name="total_cbm" id="total_cbm" readonly
                                class="form-control tx-bold tx-dark form-control-sm border-0 text-right readonly tx-14 bg-transparent"
                                placeholder="0">
                        </th>
                    </tr>
