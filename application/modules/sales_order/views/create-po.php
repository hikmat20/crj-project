    ...
    <div class="card shadow-sm mg-b-25 border-0">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="attention" required id="attention" class="form-control form-controlsm" placeholder="Attn. Name" value="<?= $dataSO->attention; ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">P/O No. <span class="tx-danger">*</span></label>
                        <input type="text" name="po_number" required id="po_number" class="form-control form-controlsm" placeholder="PO Number">
                    </div>
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">P/O ISSUE DATE <span class="tx-danger">*</span></label>
                        <input type="date" name="po_date" required id="po_date" class="form-control form-controlsm" placeholder="PO Date" max="<?= date('Y-m-d'); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="approve_by" required id="approve_by" class="form-control w-25" placeholder="Empl. Name" aria-describedby="helpId">
            </div>
