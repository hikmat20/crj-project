            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="sc_number" required id="sc_number"
                            value="<?= $dataSO->invoice_number; ?>" class="form-control form-controlsm"
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="sc_date" required id="sc_date" class="form-control form-controlsm"
                            value="<?= $dataSO->invoice_date; ?>" placeholder="Date" max="<?= date('Y-m-d'); ?>">
                    </div>
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">Signed At</label>
                        <input type="date" name="signed_at" id="signed_at" class="form-control form-controlsm" value=""
                            max="<?= date('Y-m-d'); ?>">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="company_fax" id="company_fax" class="form-control form-controlsm"
                            placeholder="Fax" value="<?= $company->fax; ?>">
                    </div>
                    <div class="form-group">
                        <label for="" class="text-uppercase tx-dark tx-bold">EMAIL</label>
                        <input type="email" name="email" required id="email"
                            class="form-control form-controlsm text-uppercase" placeholder="VAT/NPWP"
                            value="<?= ($dataSO->email); ?>">
                    </div>
                </div>
            </div>
