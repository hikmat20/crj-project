            ...
            <div class="alert alert-primary tx-dark">
                ...
                <div class="row px-2">
                    ...
                    <div class="col-12 px-0 pt-2">
                        <button type="button" class="btn btn-info btn-sm" id="more-detail"><i class="fa fa-list" aria-hidden="true"></i> More Detail</button>
                    </div>
                </div>
            </div>
            ...
            <div class="mg-t-30">
                ...
                <table class="table table-hover">
                    <tbody>
                        <tr>
                            <th>
                                <span class="h5 tx-bold"><i class="fa fa-file-alt <?= ($SO->flag_invoice == 'Y') ? 'text-success' : 'text-secondary'; ?> " aria-hidden="true"></i> Invoice</span>
                            </th>
                            <th width="200" class="text-right">
                                <?php if ($SO->flag_invoice == "Y") : ?>
                                    <button type="button" class="btn bg-light text-primary btn-sm" id="edit-invoice" data-id="<?= $SO->id; ?>"><i class="fa fa-pen" aria-hidden="true"></i></button>
                                    <button type="button" class="btn bg-light text-primary btn-sm" id="view-invoice" data-id="<?= $SO->id; ?>"><i class="fa fa-eye" aria-hidden="true"></i></button>
                                    <button onclick="window.open(siteurl+thisController+'print_invoice/'+'<?= $SO->id; ?>','_blank')" class="btn btn-sm text-primary bg-light" data-id="<?= $SO->id; ?>"><i class="fa fa-print" aria-hidden="true"></i></button>
                                <?php else : ?>
                                    <button type="button" class="btn bg-light btn-sm" id="create-invoice"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                <?php endif; ?>
                            </th>
                        </tr>
                        <tr>
                            <th>
                                <span class="h5 tx-bold"><i class="fa fa-file-alt  <?= ($SO->flag_pl == 'Y') ? 'text-success' : 'text-secondary'; ?> " aria-hidden="true"></i> Packing List</span>
                            </th>
                            <th class="text-right">
                                <?php if ($SO->flag_invoice == 'Y') : ?>
                                    <?php if ($SO->flag_pl == 'Y') : ?>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="edit-packing-list" data-id="<?= $SO->id; ?>"><i class="fa fa-pen" aria-hidden="true"></i></button>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="view-packing-list" data-id="<?= $SO->id; ?>"><i class="fa fa-eye" aria-hidden="true"></i></button>
                                        <button onclick="window.open(siteurl+thisController+'printPackingList/'+'<?= $SO->id; ?>','_blank')" class="btn btn-sm text-primary bg-light" data-id="<?= $SO->id; ?>"><i class="fa fa-print" aria-hidden="true"></i></button>
                                    <?php else : ?>
                                        <button type="button" class="btn bg-light btn-sm" id="create-packing-list"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </th>
                        </tr>
                        <tr>
                            <th>
                                <span class="h5 tx-bold"><i class="fa fa-file-alt <?= ($SO->flag_bl == 'Y') ? 'text-success' : 'text-secondary'; ?> " aria-hidden=" true"></i> Bill of Lading</span>
                            </th>
                            <th class="text-right">
                                <?php if ($SO->flag_pl == 'Y') : ?>
                                    <?php if ($SO->flag_bl == 'Y') : ?>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="edit-bl" data-id="<?= $SO->id; ?>"><i class="fa fa-pen" aria-hidden="true"></i></button>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="view-bl" data-id="<?= $SO->id; ?>"><i class="fa fa-eye" aria-hidden="true"></i></button>
                                        <button onclick="window.open(siteurl+thisController+'printbl/'+'<?= $SO->id; ?>','_blank')" class="btn btn-sm text-primary bg-light" data-id="<?= $SO->id; ?>"><i class="fa fa-print" aria-hidden="true"></i></button>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="delete-bl" data-id="<?= $SO->id; ?>"><i class="fa fa-trash-alt" aria-hidden="true"></i></button>
                                    <?php else : ?>
                                        <button type="button" class="btn bg-light btn-sm" id="create-bl"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </th>
                        </tr>
                        <tr>
                            <th>
                                <span class="h5 tx-bold"><i class="fa fa-file-alt <?= ($SO->flag_fe == 'Y') ? 'text-success' : 'text-secondary'; ?>" aria-hidden="true"></i> Form E</span>
                            </th>
                            <th class="text-right">
                                <?php if ($SO->flag_bl == 'Y') : ?>
                                    <?php if ($SO->flag_fe == 'Y') : ?>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="edit-fe" data-id="<?= $SO->id; ?>"><i class="fa fa-pen" aria-hidden="true"></i></button>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="view-fe" data-id="<?= $SO->id; ?>"><i class="fa fa-eye" aria-hidden="true"></i></button>
                                        <button onclick="window.open(siteurl+thisController+'printfe/'+'<?= $SO->id; ?>','_blank')" class="btn btn-sm text-primary bg-light" data-id="<?= $SO->id; ?>"><i class="fa fa-print" aria-hidden="true"></i></button>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="delete-fe" data-id="<?= $SO->id; ?>"><i class="fa fa-trash-alt" aria-hidden="true"></i></button>
                                    <?php else : ?>
                                        <button type="button" class="btn bg-light btn-sm" id="create-fe"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </th>
                        </tr>
                        <tr>
                            <th>
                                <span class="h5 tx-bold"><i class="fa fa-file-alt <?= ($SO->flag_po == 'Y') ? 'text-success' : 'text-secondary'; ?>" aria-hidden="true"></i> Purchase Order</span>
                            </th>
                            <th class="text-right">
                                <?php if ($SO->flag_fe == 'Y') : ?>
                                    <?php if ($SO->flag_po == 'Y') : ?>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="edit-po" data-id="<?= $SO->id; ?>"><i class="fa fa-pen" aria-hidden="true"></i></button>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="view-po" data-id="<?= $SO->id; ?>"><i class="fa fa-eye" aria-hidden="true"></i></button>
                                        <button onclick="window.open(siteurl+thisController+'printpo/'+'<?= $SO->id; ?>','_blank')" class="btn btn-sm text-primary bg-light" data-id="<?= $SO->id; ?>"><i class="fa fa-print" aria-hidden="true"></i></button>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="delete-po" data-id="<?= $SO->id; ?>"><i class="fa fa-trash-alt" aria-hidden="true"></i></button>
                                    <?php else : ?>
                                        <button type="button" class="btn bg-light btn-sm" id="create-po"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </th>
                        </tr>
                        <tr>
                            <th>
                                <span class="h5 tx-bold"><i class="fa fa-file-alt <?= ($SO->flag_sc == 'Y') ? 'text-success' : 'text-secondary'; ?>" aria-hidden="true"></i> Sales Contract</span>
                            </th>
                            <th class="text-right">
                                <?php if ($SO->flag_fe == 'Y') : ?>
                                    <?php if ($SO->flag_sc == 'Y') : ?>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="edit-sc" data-id="<?= $SO->id; ?>"><i class="fa fa-pen" aria-hidden="true"></i></button>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="view-sc" data-id="<?= $SO->id; ?>"><i class="fa fa-eye" aria-hidden="true"></i></button>
                                        <button onclick="window.open(siteurl+thisController+'printsc/'+'<?= $SO->id; ?>','_blank')" class="btn btn-sm text-primary bg-light" data-id="<?= $SO->id; ?>"><i class="fa fa-print" aria-hidden="true"></i></button>
                                        <button type="button" class="btn bg-light text-primary btn-sm" id="delete-sc" data-id="<?= $SO->id; ?>"><i class="fa fa-trash-alt" aria-hidden="true"></i></button>
                                    <?php else : ?>
                                        <button type="button" class="btn bg-light btn-sm" id="create-sc"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </th>
                        </tr>
...
<!-- Modal -->
<div class="modal fade" id="modalID" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="modelTitleId" aria-hidden="true">
...
<div class="modal fade" id="modalUpload" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="alert alert-info alert-bordered pd-y-20" role="alert">
                    <div class="d-flex align-items-center justify-content-start">
                        ...
                        <div>
                            ...
                            <a target="_blank" href="<?= base_url($this->uri->segment(1) . "/export/" . $header->id); ?>" class="link">Template upload &nbsp;<i class="fa fa-external-link-alt" aria-hidden="true"></i></a>
                        </div>
                    </div><!-- d-flex -->
                </div><!-- alert -->
                ...
                <div class="mb-3">
                    ...
                    <form id="form-upload" data-parsley-validate>
                        <input type="file" name="uploadFile" data-parsley-require required class="form-control" id="uploadFile" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel,.csv,">
                    </form>
                </div>
