    ...
    <div class="card shadow-sm mg-b-25 border-0">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="id" id="id" class="form-control" value="<?= $dataSO->id; ?>">
                    ...
                    <div class="form-group">
                        <textarea name="supplier_address" required id="supplier_address" rows="3" class="form-control" placeholder="Address"><?= $dataSO->supplier_address; ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">Notify address: <span class="tx-danger">*</span></label>
                        <textarea name="notify_address" required id="notify_address" rows="3" class="form-control" placeholder="Address"><?= $dataSO->notify_address; ?></textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="tx-dark tx-bold">References No. <span class="tx-danger">*</span></label>
                        <input type="text" name="reference" required id="reference" class="wd-50p form-control" placeholder="xxx-xxx-xxxx" value="<?= $dataSO->reference; ?>">
                    </div>
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">Consignee: <span class="tx-danger">*</span></label>
                        <input type="text" required id="company_name" class="form-control" placeholder="Company Name" value="<?= ($dataSO->qq == 'Y') ? $dataSO->company_name . " QQ " . $dataSO->qq_company_name : $dataSO->company_name; ?>">
                    </div>
                    <div class="form-group">
                        <textarea required id="company_address" rows="3" class="form-control" placeholder="Address"><?= $dataSO->company_address; ?></textarea>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" class="tx-bold tx-dark tx-12">Vessel: <span class="tx-danger">*</span></label>
                                <input type="text" required name="vessel" id="vessel" value="<?= $dataSO->vessel; ?>" class="form-control" placeholder="Vessel">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="" class="tx-bold tx-dark tx-12">Port of Loading: <span class="tx-danger">*</span></label>
                                <input type="text" required name="from" value="<?= $dataSO->from; ?>" id="from" class="form-control" placeholder="Port of Loading">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark tx-12">Port of Discharge: <span class="tx-danger">*</span></label>
                        <input type="text" required name="to" id="to" value="<?= $dataSO->to; ?>" class="form-control" placeholder="Port of Discharge">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="" class="tx-dark tx-bold tx-12">SHIPPING MARK <span class="tx-danger">*</span></label>
                        <input type="text" required name="shipping_mark" id="shipping_mark" value="<?= $dataSO->shipping_mark; ?>" class="form-control" placeholder="N/M" value="N/M" aria-describedby="helpId">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-3 offset-9">
                    <div class="form-group">
                        ...
                        <input type="text" name="place_and_date" id="place_and_date" value="<?= $dataSO->place_and_date; ?>" class="form-control" placeholder=".........,.............,........">
                    </div>
                </div>
            </div>
