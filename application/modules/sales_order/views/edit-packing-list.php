            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="invoice_number" required class="form-control form-control-sm" value="<?= $data->invoice_number; ?>" placeholder="Invoice Number" aria-describedby="helpId">
                    </div>

                    <div class="form-group">
                        <label for="" class="tx-dark tx-bold">PL Date <span class="text-danger">*</span> :</label>
                        <input type="date" name="invoice_date" required class="form-control form-control-sm" max="<?= date('Y-m-d'); ?>" value="<?= $data->invoice_date; ?>" placeholder="Invoice Date" aria-describedby="helpId">
                    </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <label class="ckbox ckbox-primary tx-bold tx-dark wd-1">
                                    <input type="checkbox" name="detail[<?= $n; ?>][flag_bl]" id="flag-bl" class="wd-1" value="Y" <?= ($dtl->flag_bl == 'Y') ? 'checked' : ''; ?>>
                                    <span></span>
                                </label>
                            </td>
                            <td>
                                <label class="ckbox ckbox-primary tx-bold tx-dark wd-1">
                                    <input type="checkbox" name="detail[<?= $n; ?>][hide_spec]" class="wd-1" value="Y" <?= ($dtl->hide_spec == 'Y') ? 'checked' : ''; ?>>
                                    <span></span>
                                </label>
                            </td>
                            <td>
                                <label class="ckbox ckbox-primary tx-bold tx-dark wd-1">
                                    <input type="checkbox" name="detail[<?= $n; ?>][hide_qty]" class="wd-1" value="Y" <?= ($dtl->hide_qty == 'Y') ? 'checked' : ''; ?>>
                                    <span></span>
                                </label>
                            </td>
                            <td>
                                <label class="ckbox ckbox-primary tx-bold tx-dark wd-1">
                                    <input type="checkbox" name="detail[<?= $n; ?>][hide_nw]" class="wd-1" value="Y" <?= ($dtl->hide_nw == 'Y') ? 'checked' : ''; ?>>
                                    <span></span>
                                </label>
                            </td>
                            <td>
                                <label class="ckbox ckbox-primary tx-bold tx-dark wd-1">
                                    <input type="checkbox" name="detail[<?= $n; ?>][hide_gw]" class="wd-1" value="Y" <?= ($dtl->hide_gw == 'Y') ? 'checked' : ''; ?>>
                                    <span></span>
                                </label>
                            </td>
