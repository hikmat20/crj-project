                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <label class="ckbox ckbox-primary tx-bold tx-dark wd-1">
                                <input type="checkbox" name="detail[<?= $n; ?>][flag_bl]" id="flag-bl" class="wd-1 ckBl"
                        ...
                        <td>
                            <label class="ckbox ckbox-primary tx-bold tx-dark wd-1">
                                <input type="checkbox" name="detail[<?= $n; ?>][hide_spec]" class="wd-1 ckSpec"
                                    value="Y" <?= ($dtl->hide_spec == 'Y') ? 'checked' : ''; ?>>
                                <span></span>
                            </label>
                        </td>
                        <td>
                            <label class="ckbox ckbox-primary tx-bold tx-dark wd-1">
                                <input type="checkbox" name="detail[<?= $n; ?>][hide_qty]" class="wd-1 ckHqty" value="Y"
