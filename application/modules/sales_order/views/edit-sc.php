        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="supplier_fax" id="supplier_fax" class="form-control form-controlsm" placeholder="Fax" value="<?= $dataSO->supplier_fax; ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">No. <span class="tx-danger">*</span></label>
                        <input type="text" name="sc_number" required id="sc_number" class="form-control form-controlsm" value="<?= $dataSO->sc_number; ?>" placeholder="SC Number">
                    </div>
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">DATE <span class="tx-danger">*</span></label>
                        <input type="date" name="sc_date" required id="sc_date" class="form-control form-controlsm" value="<?= $dataSO->sc_date; ?>" placeholder="Date" max="<?= date('Y-m-d'); ?>">
                    </div>
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">Signed At</label>
                        <input type="date" name="signed_at" id="signed_at" class="form-control form-controlsm" value="<?= $dataSO->signed_at; ?>" max="<?= date('Y-m-d'); ?>">
                    </div>
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">Fax.</label>
                        <input type="text" name="company_fax" id="company_fax" class="form-control form-controlsm" placeholder="Fax" value="<?= $dataSO->company_fax; ?>">
                    </div>
                </div>
            </div>
            <br>
