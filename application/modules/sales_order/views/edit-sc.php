        ...
        <div class="card-body">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="supplier_name" id="supplier_name" class="form-control"
                            value="<?= $dataSO->supplier_name; ?>" placeholder="Shipper Name" required
                            data-parsley-inputs>
                    </div>
                    <div class="form-group">
                        <textarea name="supplier_address" required id="supplier_address" rows="3"
                            class="form-control form-controlsm"
                            placeholder="Address"><?= $dataSO->supplier_address; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">Fax.</label>
                        <input type="text" name="supplier_fax" id="supplier_fax" class="form-control form-controlsm"
                            placeholder="Fax" value="<?= $dataSO->supplier_fax; ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">No. <span class="tx-danger">*</span></label>
                        <input type="text" name="sc_number" required id="sc_number" class="form-control form-controlsm"
                            value="<?= $dataSO->sc_number; ?>" placeholder="SC Number">
                    </div>
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">DATE <span class="tx-danger">*</span></label>
                        <input type="date" name="sc_date" required id="sc_date" class="form-control form-controlsm"
                            value="<?= $dataSO->sc_date; ?>" placeholder="Date" max="<?= date('Y-m-d'); ?>">
                    </div>
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">Signed At</label>
                        <input type="date" name="signed_at" id="signed_at" class="form-control form-controlsm"
                            value="<?= $dataSO->signed_at; ?>" max="<?= date('Y-m-d'); ?>">
                    </div>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="company_name" required id="company_name"
                            ...
                            value="<?= $dataSO->company_name; ?>">
                    </div>
                    <div class="form-group">
                        <textarea name="company_address" required id="company_address" rows="3"
                            class="form-control form-controlsm"
                            placeholder="Address"><?= $dataSO->company_address; ?></textarea>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="" class="tx-bold tx-dark">Fax.</label>
                        <input type="text" name="company_fax" id="company_fax" class="form-control form-controlsm"
                            placeholder="Fax" value="<?= $dataSO->company_fax; ?>">
                    </div>
                    <div class="form-group">
                        <label for="" class="text-uppercase tx-dark tx-bold">EMAIL</label>
                        <input type="email" name="email" required id="email"
                            class="form-control form-controlsm text-uppercase" placeholder="EMAIL"
                            value="<?= ($dataSO->email); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="text-center mg-t-20">
                <button type="submit" class="btn btn-primary text-center wd-100" id="save-po"><i class="fa fa-save"></i>
                    Save</button>
            </div>
        </div>
    </div>
