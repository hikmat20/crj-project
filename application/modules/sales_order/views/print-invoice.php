                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td width="120" class="text-left">
                                <?= (isset($header) && $header->invoice_date) ? date('F, d Y', strtotime($header->invoice_date)) : date('d/m/Y'); ?>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <table class="bordered colored" width="100%">
            <thead>
                <tr style="background-color: #ccc;">
                    ...
                    <th class="align-middle text-right" width="100" colspan="2">UNIT
                        PRICE(<?= $symbol[$header->currency]; ?>)</th>
                    <th class="align-middle text-right" width="100" colspan="2">
                        AMOUNT(<?= $symbol[$header->currency]; ?>)</th>
                </tr>
            </thead>
            <tbody>
                <?php $n = $subtotal = 0;
            ...
            <tfoot class="">
                <tr class="">
                    ...
                    <td class="text-right tx-bold border-right-0 border tx-bold">
                        <?= number_format($header->subtotal); ?></td>
                </tr>
