...
{
	//Permission
	protected $viewPermission 	= 'Shipping_lines.View';
	protected $addPermission  	= 'Shipping_lines.Add';
	protected $managePermission = 'Shipping_lines.Manage';
	protected $deletePermission = 'Shipping_lines.Delete';
