    ...
    <div class="box-body">
        ...
        <tr class='bg-green'>
		  ...
		  <tr>
            ...
            <td hidden width='15%'><input type='number' class='form-control' id='lfinishgood' value=<?= $tr_spk->lfinishgood?> required name='lfinishgood' readonly ></td>
            <td width='15%'>
		 ...
		 <tr>
            ...
            <td hidden width='15%'><input type='number' class='form-control' id='lsisa_aktual' value=<?= $tr_spk->lsisa_aktual?>  onkeyup required name='lsisa_aktual'  ></td>
            <td width='15%'>
		 ...
		 <tr>
            ...
            <td hidden width='15%'><input type='number' class='form-control' id='lscrap_aktual' value=<?= $tr_spk->lscrap_aktual?>   onkeyup required name='lscrap_aktual'  ></td>
