 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		<div class="col-sm-12">
			...
			<th colspan='2' ><center>@Coil</center></th>
			<th colspan='3' ><center>Total Weight FG</center><Total weight/th>
			...
			<th rowspan='2' width='7%'>Lot Slitting</th>
						...
						<th width='5%'>Weight Per Roll<Total weight/th>
						<th width='5%'>Total Weight<Total weight/th>
						</tr>
			</thead>
			<tbody id="list_spk">
			<?php $loop=0;
		...
		<tr id='tr_$loop'>
			...
			echo "<th class='clone_tr2$loop'>
				<div class='clone_here2$loop'>
					<input type='number' class='form-control dt_qtyactual'  		value='$dt_spk->qtycoil' 		 id='used_qtyaktual_$loop' onkeyup='HitungTotalCoil($loop)' required name='dt[$loop][qtyaktual][]'>
				</div>
			</th>
			...
			<th class='clone_tr5$loop'>
				<div class='clone_here5$loop'>
					<input type='text' class='form-control dt_qtywidth autoNumeric'  	onblur='HitungTotalberat($loop)'	value='$dt_spk->qtywidth' 	 id='used_qtywidth_$loop' required name='dt[$loop][qtywidth][]'>
				</div>
				<div class='clone_here5x$loop'>
					<input type='hidden' class='nomorSort' value='1'>
				</div>
			</th>
			<th class='clone_tr6$loop'>
				<div class='clone_here6$loop'>
					<input type='text' class='form-control dt_width autoNumeric'  		value='0' 	 id='used_totalaktual_$loop' required name='dt[$loop][totalaktual][]' readonly>
				</div>
			</th>
			...
			<th class='clone_tr8$loop'>
				<div class='clone_here8$loop'>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				<div class="col-md-4">
					<label for="aktual">Total Berat Aktual</label>
				</div>
				<div class="col-md-8" id="aktual">
				<input type='number' class='form-control aktual' id='aktual' value="0" name='aktual' readonly >
			</div>
			</div>
		</div>
		</div>		
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="slot_sisa">
				<input type='number' class='form-control' id='lsisa_aktual' value="0" onkeyup required name='lsisa_aktual'  >
			</div>
			</div>
		</div>
		<div class="col-sm-6">
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="slot_sisa">
				<input type='number' class='form-control' id='lscrap_aktual' value="0"  onkeyup required name='lscrap_aktual'  >
			</div>
			</div>
		</div>
		<div class="col-sm-6">
...
$(document).on('blur', '#bscrap_aktual', function() {
	...
	function addinput(id){
		...
		let no_sort;
		$(".nomorSort" ).each(function() {
         no_sort = $(this).val();
		});
		
		let sort_new = getNum(no_sort) + 1;
		...
		$("<div class='clone_here5x"+id+"'><input type='hidden' class='nomorSort' value='"+sort_new+"'></div>" ).appendTo(".clone_tr5"+id);
