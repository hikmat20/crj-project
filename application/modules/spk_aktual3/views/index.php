...
<div class="box">
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_MANAGE) : ?>
			<a class="btn btn-primary btn-sm" href="<?= base_url('/spk_aktual/EditHeadernew/'.$record->id_tr_spk_produksi) ?>"  title="Input LHP Material"><i class="fa fa-edit"></i></i></a>
			...
			<a class="btn btn-warning btn-sm" href="<?= base_url('/spk_aktual/EditHeader/'.$record->id_spkproduksi) ?>"  title="Input LHP Material Gabungan"><i class="fa fa-plus"></i></i></a>
			<?php endif; ?>
			<?php if($ENABLE_MANAGE) : ?>
			<a class="btn btn-success btn-sm" href="<?= base_url('/spk_aktual/TambahLHP/'.$record->id_tr_spk_produksi) ?>"  title="Input LHP"><i class="fa fa-edit"></i></i></a>
				</a>
			<?php endif; ?>
			
			<?php if($ENABLE_MANAGE) : ?>
			<button type='button' class="btn btn-danger btn-sm reject" data-id_spkproduksi='<?=$record->id_tr_spk_produksi;?>' title="Back To Produksi"><i class="fa fa-reply"></i></i></button>
