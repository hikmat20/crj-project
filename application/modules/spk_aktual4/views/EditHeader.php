						...
						$spkmar = $nosurat->no_surat;
							  ...
							  for($loop1=0;$loop1<$countfiles;$loop1++){
								...
								<tr id='tr_$i$loop'>
									...
									<th>
									<input type='text' class='form-control dt_qtywidth autoNumeric'  	onblur='HitungTotalberat($i$loop)'	value='$dt_spk->width' 	 id='used_qtywidth_$i$loop' required name='dt[$i$loop][qtywidth][]'>
...
<script type="text/javascript">
	...
	function totalBalanced(){
		...
		$('.difference').val(number_format(totalDifference*(-1),2));
