 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		<tr id='tr_$loop'>
			...
			echo "<th class='clone_tr2$loop'>
				<div class='clone_here2$loop'>
					<input type='number' class='form-control'  		value='$dt_spk->qtyaktual' 		 id='used_qtyaktual_$loop' onkeyup='HitungTotalCoil($loop)' required name='dt[$loop][qtyaktual][]'>
				</div>
			</th>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				<div class="col-md-4">
					<label for="no_penawaran">Lebar Aktual Sisa Potongan</label>
				</div>
				<div class="col-md-8" id="slot_sisa">
				<input type='number' class='form-control' id='lsisa_aktual' onkeyup required name='lsisa_aktual' value="<?= $tr_spk->lsisa_aktual ?>" readonly >
			</div>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group row">
				<div class="col-md-4">
					<label for="no_penawaran">Berat Aktual Sisa Potongan</label>
				</div>
				<div class="col-md-8" id="slot_sisa">
				<input type='number' class='form-control' value="<?= $tr_spk->bsisa_aktual ?>" id='bsisa_aktual' onkeyup required name='bsisa_aktual' readonly >
			</div>
			</div>
		</div>	
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="slot_sisa">
				<input type='number' class='form-control' id='lscrap_aktual'  onkeyup required name='lscrap_aktual' value="<?=  $tr_spk->lscrap_aktual ?>" readonly>
			</div>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="slot_sisa">
				<input type='number' class='form-control' id='bscrap_aktual' value="<?=  $tr_spk->bscrap_aktual ?>" onkeyup required name='bscrap_aktual'  readonly>
			</div>
			</div>
		</div>	
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<input type='number' class='form-control difference' id='difference' value="<?=  $tr_spk->difference ?>" name='difference' readonly >
			</div>
			</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<input type='number' class='form-control differencepercent' id='differencepercent' value="<?=  $tr_spk->differencepercent ?>" name='differencepercent' readonly >
			</div>
			</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<input type='number' class='form-control balance' id='balance' value="<?=  $tr_spk->balance ?>" name='balance' readonly >
			</div>
			</div>
		</div>
		</div>
