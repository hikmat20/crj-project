 ...
 <div class="box box-primary">
	...
	<label>B. Produksi<label>
		...
		<div class="form-group row" >
			...
			<tr class='bg-blue'>
			<th width='3%'>No</th>
			<th width='15%'>No. SPK MARKETING</th>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<center>
		<a class="btn btn-success btn-sm" href="<?= base_url('/spk_aktual/PrintHeader2/'.$tr_spk->id_spkproduksi) ?>" target="_blank"  title="Cetak"><i class="fa fa-print">&nbsp;</i>Cetak Laporan Produksi</i></a>
