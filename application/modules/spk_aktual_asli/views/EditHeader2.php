 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		<div class='form-group row'>
			...
			<div class='col-sm-2'>
				<input type="text" name="date_production" id="date_production" value='<?= date('d-m-Y', strtotime($tr_spk->tgl_produksi))?>' class="form-control input-sm datepicker" placeholder="Tanggal Produksi" readonly />
			</div>
		</div>
		...
		<tr id='tr_$loop'>
			<th>$loop</th>
			<th ><input type='text' class='form-control' 	value='$dt_spk->no_surat' 	readonly id='used_nosurat_$loop' required name='dt[$loop][nosurat]'></th>
			...
			<th><input type='text' class='form-control'  	   	value='$dt_spk->namacustomer' 	readonly id='used_namacustomer_$loop' required name='dt[$loop][namacustomer]'></th>
			...
			<th class='clone_tr5$loop'>
				<div class='clone_here5$loop'>
					<input type='text' class='form-control dt_width autoNumeric'  		value='$dt_spk->totalaktual' 	 id='used_totalaktual_$loop' required name='dt[$loop][totalaktual][]'>
				</div>
			</th>
			...
			<th class='clone_tr7$loop'>
				<div class='clone_here7$loop'>
					<input type='text' class='form-control'   		value='$dt_spk->lot_slitting'                         id='lot_slitting_$loop' required name='dt[$loop][lot_slitting][]'>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="slot_jpisau">
				<input type='number' class='form-control' id='terpakai' value="<?= $tr_spk->terpakai ?>" onkeyup required name='terpakai' readonly >
			</div>
			</div>
		</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<input type='number' class='form-control' id='lsisa_planing' value="<?= $tr_spk->lsisa_planing ?>" onkeyup required name='lsisa_planing' readonly >
			</div>
			</div>
		</div>
				<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="slot_sisa">
				<input type='number' class='form-control' id='bsisa_planing' value="<?= $tr_spk->bsisa_planing ?>" onkeyup required name='bsisa_planing' readonly >
			</div>
			</div>
		</div>	
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="slot_sisa">
				<input type='number' class='form-control' id='lsisa_aktual' onkeyup required name='lsisa_aktual' value="<?= $tr_spk->lsisa_aktual ?>" >
			</div>
			</div>
		</div>
		<div class="col-sm-6">
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="slot_sisa">
				<input type='number' class='form-control' id='lscrap_planing' value="<?= $tr_spk->lscrap_planning ?>" onkeyup required name='lscrap_planing' readonly >
			</div>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="slot_sisa">
				<input type='number' class='form-control' id='bscrap_planing' value="<?=  $tr_spk->bscrap_planning ?>" onkeyup required name='bscrap_planing' readonly >
			</div>
			</div>
		</div>	
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="slot_sisa">
				<input type='number' class='form-control' id='lscrap_aktual'  onkeyup required name='lscrap_aktual' value="<?=  $tr_spk->lscrap_aktual ?>" >
			</div>
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="slot_sisa">
				<input type='number' class='form-control' id='bscrap_aktual' value="<?=  $tr_spk->bscrap_aktual ?>" onkeyup required name='bscrap_aktual'  >
			</div>
			</div>
		</div>	
		</div>
		...
		$dt1  = $tr_spk->in_lebar;
	    $datajson =json_decode($dt1);
				
		$dt2  = $tr_spk->in_berat;
		$datajson2 =json_decode($dt2);
		
		$dt3  = $tr_spk->in_ket;
		$datajson3 =json_decode($dt3);
		
		$dt4  = $tr_spk->in_upload;
		$datajson4 =json_decode($dt4);
		
		
		
		$et1  = $tr_spk->ek_lebar;
	    $datajsone=json_decode($et1);
				
		$et2  = $tr_spk->ek_berat;
		$datajsone2 =json_decode($et2);
		
		$et3  = $tr_spk->ek_ket;
		$datajsone3 =json_decode($et3);
		
		$et4  = $tr_spk->ek_upload;
		$datajsone4 =json_decode($et4);
		...
		<div class="col-sm-12 ngIN">
			<div class="col-sm-12 ngINApp">
				<div class="form-group row">
					...
					<div class="col-md-2">
					<?php
					foreach ($datajson as $l) { ?>
						<input type='text' class='form-control autoNumeric' name='ngin_lebar[]' placeholder='Lebar' value="<?=  $l?>" >
					<br>
					<?php
					}
					?>
					...
					<div class="col-md-2">
					<?php
					foreach ($datajson2 as $b) { ?>
						<input type='text' class='form-control autoNumeric BeratAuto' name='ngin_berat[]' placeholder='Berat' value="<?=  $b ?>">
					<br>
					<?php
					}
					?>
					...
					<div class="col-md-2">
					<?php
					foreach ($datajson3 as $k) { ?>
						<input type='text' class='form-control ket' name='ngin_ket[]' placeholder='Keterangan' value="<?=  $k?>" >
					<br>
					<?php
					}
					?>
					...
					<div class="col-md-3">
					<?php
					foreach ($datajson4 as $u) { ?>
						<input type='file' class='form-control file' name='ngin_upload[]' placeholder='Upload' value="<?=  $u?>" >
					<br>
					<?php
					}
					?>
		...
		<div class="col-sm-12 ngEK">
			<div class="col-sm-12 ngEKApp">
				<div class="form-group row">
					...
					<div class="col-md-2">
					<?php
					foreach ($datajsone as $el) { ?>
						<input type='text' class='form-control autoNumeric' name='ngek_lebar[]' placeholder='Lebar' value="<?=  $el?>" >
					<br>
					<?php
					}
					?>
					...
					<div class="col-md-2">
				    <?php
					foreach ($datajsone2 as $eb) { ?>
						<input type='text' class='form-control autoNumeric BeratAuto' name='ngek_berat[]' placeholder='Berat' value="<?=  $eb?>">
					<br>
					<?php
					}
					?>
					...
					<div class="col-md-2">
					  <?php
					foreach ($datajsone3 as $ek) { ?>
						<input type='text' class='form-control' name='ngek_ket[]' placeholder='Keterangan' value="<?=  $ek?>" >
					<br>
					<?php
					}
					?>
					...
					<div class="col-md-3">
					 <?php
					foreach ($datajsone4 as $eu) { ?>
						<input type='file' class='form-control' name='ngek_upload[]' placeholder='Upload' value="<?=  $eu?>" >
					<br>
					<?php
					}
					?>
