...
<div class="box">
	<div class="box-body">
		...
		<tr>
			...
			<?php if($ENABLE_MANAGE) : ?>
			<a class="btn btn-primary btn-sm" href="<?= base_url('/spk_aktual/EditHeader/'.$record->id_spkproduksi) ?>"  title="Input LHP Material"><i class="fa fa-edit"></i></i></a>
			
			<a class="btn btn-danger btn-sm" href="<?= base_url('/spk_aktual/EditHeader/View/'.$record->id_spkproduksi) ?>"  title="View LHP Material"><i class="fa fa-eye"></i></i></a>
				</a>
			<a class="btn btn-success btn-sm" href="<?= base_url('/spk_aktual/EditHeader/Edit/'.$record->id_spkproduksi) ?>"  title="Edit LHP Material"><i class="fa fa-pencil"></i></i></a>
				</a>
			<?php endif; ?>
			<?php if($ENABLE_MANAGE) : ?>
			...
			<?php if($ENABLE_MANAGE) : 
				...
				?>
					<button type='button' class="btn btn-success btn-sm approve" data-id_spkproduksi='<?=$record->id_spkproduksi;?>' title="Approve"><i class="fa fa-check"></i></i></button>
			<?php } endif; ?>
			</td>
			<?php } ?>
		</tr>
