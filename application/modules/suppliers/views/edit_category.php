		...
		<form id="data-form" method="post">
					  <div class="col-sm-12">
						   <div class="input_fields_wrap2">
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="" value="<?= $category->name_category_supplier ?>" required name="name_category_supplier" placeholder="Category Supliery">
									    </div>
										</div>
									    ...
									    <div class="col-md-6">
											<input type="text" class="form-control" id="" value="<?= $category->supplier_code ?>" required name="supplier_code" placeholder="Category Suplier Code">
									    </div>
										</div>
										</div>
						  </div>
