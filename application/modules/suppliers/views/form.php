<div class="card-body" id="data-form-supplier">
	<div class="row">
		<div class="col-sm-6">
			...
			<div class="form-group row">
				<div class="col-md-3 tx-dark tx-bold">
					<label for="supplier_name">Nama Supplier <span class="tx-danger">*</span></label>
				</div>
				<div class="col-md-8">
					<input type="text" class="form-control" id="supplier_name" value="<?= isset($supplier) ? $supplier->supplier_name : null; ?>" required name="supplier_name" placeholder="Nama Supplier">
				</div>
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-md-8">
					<input type="text" class="form-control" id="telephone" value="<?= isset($supplier) ? $supplier->telephone : ''; ?>" required name="telephone" placeholder="Nomor Telephone">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-md-3 tx-dark tx-bold">
				...
				<div class="col-md-8">
					<input type="text" class="form-control" id="telephone_alt" value="<?= isset($supplier) ? $supplier->telephone_alt : ''; ?>" name="telephone_alt" placeholder="Alt. Telephone">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-md-3 tx-dark tx-bold">
				...
				<div class="col-md-8">
					<input type="text" class="form-control" id="fax" name="fax" value="<?= isset($supplier) ? $supplier->fax : ''; ?>" placeholder="Nomor Fax">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-md-3 tx-dark tx-bold">
			...
			<div class="form-group row">
				...
				<div class="col-md-8">
					<input type="date" class="form-control" id="start_date" value="<?= isset($supplier) ? $supplier->start_date : ''; ?>" required name="start_date" placeholder="Tanggal Mulai">
				</div>
			</div>
		</div>
		<div class="col-sm-6">
				...
				<div class="col-md-8">
					<div id="cbWrapperStatus" class="parsley-checkbox mg-b-0">
						<label class="rdiobox rdiobox-success d-inline-block mg-r-5">
							<input type="radio" id="statusActive" <?= isset($supplier) && $supplier->status == '1' ? 'checked' : null; ?> name="status" value="1" required data-required="true" data-parsley-inputs data-parsley-class-handler="#cbWrapperStatus" data-parsley-errors-container="#cbErrorContainerStatus">
							<span>Active</span>
						</label>
						<label class="rdiobox rdiobox-success d-inline-block mg-r-5">
		...
		<div class="tab-pane fade" id="bank_info">
			<div class="card-body">
				<div class="form-group row">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" id="bank_name" value="<?= isset($supplier) ? $supplier->bank_name : null; ?>" name="bank_name" placeholder="Nama Bank">
					</div>
				</div>
				<div class="form-group row">
					<div class="col-md-2 tx-dark tx-bold">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" id="bank_account_number" value="<?= isset($supplier) ? $supplier->bank_account_number : null; ?>" name="bank_account_number" placeholder="No Rekening">
					</div>
				</div>
				<div class="form-group row">
					<div class="col-md-2 tx-dark tx-bold">
					...
					<div class="col-md-6">
						<input type="text" class="form-control" id="bank_account_name" value="<?= isset($supplier) ? $supplier->bank_account_name : null; ?>" name="bank_account_name" placeholder="Nama Rekening">
					</div>
				</div>
				<div class="form-group row">
					<div class="col-md-2 tx-dark tx-bold">
					...
					<div class="col-md-6">
						<textarea type="text" name="bank_account_address" id="bank_account_address" class="form-control input-sm w70" placeholder="Alamat_Bank"><?= isset($supplier) ? $supplier->bank_account_address : null; ?></textarea>
					</div>
				</div>
				<div class="form-group row">
					<div class="col-md-2 tx-dark tx-bold">
