<?php
$ENABLE_ADD     = has_permission('Surveyors.Add');
$ENABLE_MANAGE  = has_permission('Surveyors.Manage');
$ENABLE_VIEW    = has_permission('Surveyors.View');
$ENABLE_DELETE  = has_permission('Surveyors.Delete');
?>
