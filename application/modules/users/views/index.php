...
<div class="box box-primary">
    ...
    <div class="box-header">
        <div class="form-group">
            ...
            <a href="<?= site_url('users/setting/create') ?>" class="btn btn-success"
                title="<?= lang('users_btn_new') ?>"><?= lang('users_btn_new') ?></a>
            <?php endif; ?>
        ...
        <table class="table table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $record->city ?></td>
                    <td><?= $record->phone ?></td>
                    <td><?= ($record->status == 0) ? "<label class='label label-danger'>".lang('users_td_aktif')."</label>" : "<label class='label label-success'>".lang('users_aktif')."</label>" ?>
                    </td>
                    <?php if($ENABLE_MANAGE) : ?>
                    <td style="padding-right:20px">
                        ...
                        <?php if($record->id_user != 1) : ?>
                        &nbsp;|&nbsp;
                        <a class="text-black" href="<?= site_url('users/setting/permission/' . $record->id_user); ?>"
    ...
    <div class="box-footer clearfix">
        ...
        <input type="submit" name="delete" class="btn btn-danger" id="delete-me"
            value="<?php echo lang('users_btn_delete') ?>"
            onclick="return confirm('<?= (lang('users_del_confirm')); ?>')">
        <?php endif;
