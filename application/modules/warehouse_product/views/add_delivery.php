      ...
      <div class="form-group row">
          ...
          <select id="delivery" name="delivery" class="form-control input-md chosen-select" <?=$dist;?>>
						...
						<?php foreach (get_date_delivery() AS $val => $valx){ ?>
						        <option value="<?= $valx['no_so'];?>"><?= date('d F Y',strtotime($valx['delivery_date']))." - ".strtoupper(get_name_field('master_customer', 'name_customer', 'id_customer', $valx['code_cust']));?></option>
						<?php } ?>
					</select>
				</div>
