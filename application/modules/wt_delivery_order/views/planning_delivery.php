					...
					<table class='table table-bordered table-striped'>
						...
						foreach ($results['detail'] as $dt_spk){$loop++; 
							...
							echo	"</select>
								...
								<td id='qty_so_$loop'><input type='text' class='form-control input-sm' id='used_qty_so_$loop' required name='qty_so[]' value='$dt_spk->qty_so' readonly tabindex='-1'></td>
								...
								<td id='qty_delivery_$loop'><input type='text' value='$dt_spk->qty_delivery' class='form-control input-sm' id='used_qty_delivery_$loop' required name='qty_delivery[]'></td>
