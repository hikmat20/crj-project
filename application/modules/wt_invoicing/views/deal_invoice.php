		...
		<div class="col-sm-12">
		    <div class="col-sm-6">
		        <div class="form-group row">
			        ...
			        <div class="col-md-8" hidden>
						<input type="text" class="form-control" id="id_invoice" value="<?= $hd->id_invoice?>" required name="id_invoice" readonly placeholder="No.SO">
						<input type="text" class="form-control" id="no_proforma" value="<?= $hd->no_proforma_invoice?>" required name="no_proforma" readonly placeholder="No.SO">
						 <input type="text" class="form-control" id="id_plan_tagih" value="<?= $hd->id_plan_tagih?>" required name="id_plan_tagih" readonly placeholder="No.SO">
						<input type="text" class="form-control" id="no_so" value="<?= $hd->no_so?>" required name="no_so" readonly placeholder="No.SO">
				  
					</div>
			        <div class="col-md-8">hd
		    ...
		    <div class="col-sm-6">
		        <div class="form-group row">
			        ...
			        <div class="col-md-8">
				        <input type="date" class="form-control" id="tanggal" onkeyup required name="tanggal" value="<?= $hd->tgl_invoice?>" >
			        </div>
		        </div>
		    </div>
		</div>
		...
		<div class="col-sm-12">
		    <div class="col-sm-6">
		        <div class="form-group row">
			        ...
			        <div class="col-md-8">
				        <input type="text" class="form-control" id="pembayaran" required name="pembayaran" readonly placeholder="Pembayaran" value="<?= $hd->payment?>">
			        </div>
		        </div>
		    </div>
		    <div class="col-sm-6">
		        <div class="form-group row">
			        ...
			        <div class="col-md-8">
					<input type="text" class="form-control" id="keterangan_top" required name="keterangan_top" readonly placeholder="Keterangan Top" value="<?= $hd->keterangan_top?>">
			        </div>
		        </div>
		    </div>
		</div>
		...
		<div class="col-sm-12">
		    <div class="col-sm-6">
		        <div class="form-group row">
			        ...
			        <div class="col-md-8">
				        <input type="text" class="form-control" id="reff" required name="reff" placeholder="Reff" value="<?= $hd->referensi?>"">
			        </div>
		        </div>
		    </div>
		    <div class="col-sm-6">
		        <div class="form-group row">
			        ...
			        <div class="col-md-8">
					<input type="text" class="form-control" id="faktur" required name="faktur" placeholder="Faktur" value="<?= $hd->no_faktur?>">
			        </div>
		        </div>
		    </div>
		</div>
		<div class="col-sm-12">
		    <div class="col-sm-6">
		        <div class="form-group row">
			        ...
			        <div class="col-md-8">
				        <input type="date" class="form-control" id="jatuh_tempo" required name="jatuh_tempo" value="<?= $hd->jatuh_tempo?>" placeholder="Tgl Jatuh Tempo" ">
			        </div>
		        </div>
		    </div>
			<div class="col-sm-6">
		        <div class="form-group row">
						   		...
						   		<table id="example1" class='table table-bordered table-striped table-responsive'>
									...
									foreach ($results['detail'] as $dt_spk){$loop++; 
                                        ...
                                        echo	"</select>
											...
											<td id='date_$loop'><input type='date' class='form-control input-sm' id='used_date_$loop' required name='dt[$loop][date]'  value='$dt_spk->tgl_delivery' readonly></td>
                                         	<td id='qty_so_$loop'><input type='text' class='form-control input-sm' id='used_qty_so_$loop' required name='dt[$loop][qty_so]' onblur='HitungTotal($loop)' value='$dt_spk->qty_invoice' readonly></td>
									...
									<tfoot>
									    <tr>
											...
											<th width='7%'></th>                                            
                                            <th width='7%'><input type='text' class='form-control totalproduk' id='totalproduk'  name='totalproduk' readonly value="<?= $hd->nilai_produk?>" ></th>										
										...
										<tr>
											...
											<th width='7%'><input type='text' class='form-control persentase' id='persentase'  name='persentase' value="<?= $hd->persentase?>%" readonly ></th>                                            
                                            <th width='7%'><input type='text' class='form-control nilai_tagih' id='nilai_tagih'  name='nilai_tagih' value="<?= $hd->nilai_invoice?>" readonly ></th>										
                    ...
                    <a class="btn btn-danger btn-sm" href="<?= base_url('/wt_invoicing/plan_tagih') ?>"  title="Edit">Kembali</a>
					</center>
		</form>		  
	</div>
</div>	
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'wt_invoicing/SaveNewDealInvoice';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
