								...
								<table class='table table-bordered table-striped'>
									...
									foreach ($results['detail'] as $dt_spk){$loop++; 
                                        ...
                                        echo	"</select>
											...
											<td id='date_$loop'><input type='date' class='form-control input-sm' id='used_tgl_delivery_$loop' required name='dt[$loop][tgl_delivery]' value='$dt_spk->tgl_delivery'></td>
