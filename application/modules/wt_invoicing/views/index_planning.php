...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
			...
			<td><?= $record->nilai_tagih ?></td>
			<td><?= $record->nama_top ?></td>
			<td><?= $record->payment ?></td>
			<td><?= $record->ket_tagih ?></td>
			<td style="padding-left:20px">
			<?php if($ENABLE_MANAGE && $record->status_invoice=='0')  : ?>
			<a class="btn btn-success btn-sm" href="<?= base_url('/wt_invoicing/createInvoice/'.$record->id_plan_tagih) ?>" title="Deal SO" data-no_inquiry="<?=$record->no_inquiry?>"><i class="fa fa-check">&nbsp;Create Invoice</i>
			</a> 
			<?php endif; ?>
