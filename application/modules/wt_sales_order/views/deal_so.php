...
<div class="box box-primary">
    <div class="box-body">
		...
		<div class="col-sm-12">
		    <div class="col-sm-6">
		        <div class="form-group row">
                    ...
                    <input type="text" class="form-control" id="id_so" value="<?= $hd->id_so?>" required name="id_so" readonly placeholder="No.CRCL">
		    ...
		    <div class="col-sm-6">
		        <div class="form-group row">
			        ...
			        <div class="col-md-8">
				        <input type="date" class="form-control" id="tanggal" onkeyup required name="tanggal" value="<?= $hd->tgl_so?>">
			        </div>
		        </div>
		    </div>
		</div>
        ...
        <?php } ?>
								...
								<table class='table table-bordered table-striped'>
									...
									foreach ($results['detail'] as $dt_spk){$loop++; 
                                        ...
                                        echo	"</select>
											...
											<td id='tgl_delivery_$loop'><input type='date' class='form-control input-sm' id='used_tgl_delivery_$loop' required name='dt[$loop][tgl_delivery]' value='$dt_spk->tgl_delivery'></td>
                                         	<td id='qty_so_$loop'><input type='text' class='form-control input-sm' id='used_qty_so_$loop' required name='dt[$loop][qty_so]' onblur='HitungTotal($loop)' value='$dt_spk->qty_so'></td>
                    ...
                    <a class="btn btn-danger btn-sm" href="<?= base_url('/wt_sales_order/') ?>"  title="Edit">Kembali</a>
                    </center>
		</form>		  
	</div>
</div>	
			...
			swal({
				...
				function(isConfirm) {
				  if (isConfirm) {
						...
						var baseurl=siteurl+'wt_sales_order/SaveDealSalesOrder';
						$.ajax({
							url			: baseurl,
							type		: "POST",
							data		: formData,
