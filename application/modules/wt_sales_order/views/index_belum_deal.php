...
<div class="box">
	...
	<div class="box-body">
		...
		<tr>
            ...
            <td><?= $record->total_penawaran ?></td>
			<td><?= $record->grand_total ?></td>
			<td><?= Round(($record->grand_total/$record->total_penawaran)*100)?>%</td>
			...
			<?php if($ENABLE_MANAGE)  : ?>
			<a class="btn btn-success btn-sm" href="<?= base_url('/wt_sales_order/dealSO/'.$record->id_so) ?>" title="Deal SO" data-no_inquiry="<?=$record->no_inquiry?>"><i class="fa fa-check">&nbsp;Deal SO</i>
			</a> 
			<?php endif; ?>
			<?php endif; ?>
